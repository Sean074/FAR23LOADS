...
| [`balanced_cases.md`](20_theory/balanced_cases.md) | **Balanced free-free airplane cases** — the balancing method (applied set, pre-closure residual, six-DOF d'Alembert closure, handedness) with worked wing symmetric/antisymmetric examples and the design-of-record low-tail / T-tail empennage cases |
