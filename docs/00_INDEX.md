...
| [`15_sign_convention_report_section.md`](30_future/15_sign_convention_report_section.md) | **Sign-convention summary & report section design note** — the verified sign-convention extraction (state, controls, per-component loads, diagrams, engine/rotation), the DERIVED physical moment senses, proposals P-1…P-6 for the genuinely absent conventions (β, rudder, twist, gear V/D/S, hand labels — **awaiting user approval**), and the spec for the report's "Axes and sign conventions" section with three inline TikZ figures |
