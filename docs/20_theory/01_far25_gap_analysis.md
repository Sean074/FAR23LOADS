...
| 25.335(b) VD/MD: 1.25·VC basis **or** MD ≥ MC + 0.05 / upset-analysis margin *(verify)* | 23.335(b): max(K_d·VCmin, 1.25·VC) | After M1-1: both FAR 23 floors | The Mach-margin route (MC+0.05, Ref 1 p47 already cites 23.335(b)(4) identically) becomes primary for high-subsonic concepts | **P** (ties into M2-10 ladder, VMO/MMO form) |
