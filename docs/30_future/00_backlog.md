...
code fields that silently change loads (**closed #63, 2026-08-23**), the stale project download, no
...
| 17 | **Oracle form presentation** — coefficients displayed at four decimals, leaf-name labels, help that lies *(PB-22)* (#73) | `%g` / per-unit precision; a label override table beside `MEMBER_LABELS`; the `flight_loads.mn` basis corrected | V | S / S | — |
