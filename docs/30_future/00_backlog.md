...
(re-cut 2026-08-29). **Cut 0.8.1 when band B1 is empty, then band B2 (0.9.0).** Before it: **0.8.0 is cut** — `v0.8.0`, 2026-08-28,
...
# Priority table (re-cut 2026-08-29 — the single order of work)
...
|---|---|---|---|---|---|
| **B1 — 0.8.1: released-defect correction, with the 2026-08-29 independent review's documentation band folded in (re-cut 2026-08-29)** ||||||
