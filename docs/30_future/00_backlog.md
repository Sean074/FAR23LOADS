...
instead of waiting for 0.9.0. **Cut 0.8.1 when band B1 is empty; band B3
(0.8.2, the 2026-08-29 independent-review documentation band) follows it, then
band B2 (0.9.0).** Before it: **0.8.0 is cut** — `v0.8.0`, 2026-08-28,
...
4. **The `app/views/` freeze does not lift for this band.** #121 moves ahead of
   ...
   *survives it* half plus the rule-4 sweep — and the layout half stays with
   ...
   becomes the 0.8.1 cut. Cut 0.8.1 when band B1 is empty, then 0.8.2 when
   band B3 is (added 2026-08-29 from the independent review of dev/v0.8.1),
   then 0.9.0 when band B2 is.
