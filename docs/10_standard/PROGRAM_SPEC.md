...
| `landing` (gear geometry + load factor) | LGFACTOR (writes `.n`), direct gear-geometry input | LANDLOAD; reads `landing.cg_cases` (required, weight/CG), `geometry.wing` (area) |
