...
- **Optional FAR 25 cases (concept superset):** `Project.include_far25` (default off → FAR 23 output byte-identical) appends the **14 CFR 25.361/25.371** engine cases for **turbopropeller** engines: 25.361(a)(1)(i) `1.25×takeoff torque @ 0.75n`, (a)(1)(ii) `1.25×max-cont torque @ 1.0n`, (a)(1)(iii) `1.6×takeoff @ 1g`, (a)(3)(i) `stoppage torque @ 1g`, (a)(3)(ii) `max-accel torque @ 1g`, and 25.371 gyroscopic. Since the AC 23-19A correction now factors the FAR 23 takeoff case too, for a turbopropeller the 25.361(a)(1)(i)/(ii)/(iii) torque magnitudes **coincide** with the corrected 23.361(a)(1)/(a)(2)/(a)(3); the genuine FAR 25 additions are the **1g on sudden deceleration** (a)(3)(i), the **max-accel-torque** case (a)(3)(ii), and the **A2-vs-2.5g** gyro vertical. 25.371 uses the **fixed FAR 23.371(b) rates (2.5/1.0 rad/s)** as a conservative concept stand-in for the maneuver-derived rates (the tool does not solve 25.331/341/…), with the vertical load on the **A2 limit load factor** rather than a fixed 2.5g. New optional input `EngineInput.max_accel_torque` (blank → `max_engine_torque`). Reciprocating/jet engines are out of scope (25.361(a)(2) defines no recip factor; the math is prop-centric) → no FAR 25 cases. Sourced from `reference/14CFR_Part25_engine_torque.md`; **formula-closure tested** (no McMaster Part-25 oracle). GUI: an "Add FAR 25 cases" checkbox in the engine-mount sidebar.
