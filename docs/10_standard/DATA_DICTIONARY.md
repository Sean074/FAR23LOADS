...
| `vtail_loads` | `VTailLoadsInput` | Geometry (empennage, Step G6) | `balance`, `one_engine_out`, `select`, `tail_span`, `taildist` | Rational vertical-tail inputs (via geometry.empennage) |
